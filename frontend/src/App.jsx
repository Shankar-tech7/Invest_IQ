  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/dashboard" element={<Layout><PageWrapper><DashboardPage /></PageWrapper></Layout>} />
        <Route path="/autopsy" element={<Layout><PageWrapper><AutopsyPage /></PageWrapper></Layout>} />
        <Route path="/tod" element={<Layout><PageWrapper><TODPage /></PageWrapper></Layout>} />
        <Route path="/cctv" element={<Layout><PageWrapper><CCTVPage /></PageWrapper></Layout>} />
        <Route path="/evidence" element={<Layout><PageWrapper><EvidencePage /></PageWrapper></Layout>} />
        <Route path="/reconstruction" element={<Layout><PageWrapper><ReconstructionPage /></PageWrapper></Layout>} />
...
export default function App() {
  ...
  return (
    <Router>
      <DNABackground />
      <AnimatedRoutes isLoggedIn={isLoggedIn} onLogin={handleLogin} />
    </Router>
  );
}
